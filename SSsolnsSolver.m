...
%SSsolnsSolver is a function that holds all the S.S. equations for the differential
%equations and takes in the parameters needed to solve the differential
%equations and returns the S.S. solutions
